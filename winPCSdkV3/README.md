...
3. Start Mini App page in terminal C:
...
4. Open browser on the printed Vite URL and run actions directly in UI:
- Init Client
- executeSkill
...
The IM page `Mini App Container` now loads `miniApp` project page via iframe (`Mini App URL`, default `http://127.0.0.1:3000`), and appends `sessionid` automatically for current slot.
